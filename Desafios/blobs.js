...
indicando o número de casos de teste. As N linhas seguintes contém um 
valor de ponto flutuante C (1 ≤ C ≤ 1000) correspondente à quantidade 
de comida disponível para Blobs.
...
while(n >= 1 && n <= n){
    var c = 200;
    var dias = 0;
    while (c > 1 && c <= c) { //o segredo está aqui, a divisão c/2 vai gerar decimais ainda maiores que 0, logo deve ser 1
        c = c / 2.0;
        dias++;
    }
    n--;
