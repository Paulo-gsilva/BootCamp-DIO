function start() {
	$("#inicio").hide(); //hide esconde determinado elemento
    //DIVS A SEREM CRIADAS
	...
	var jogo = {}
	jogo.timer = setInterval(loop, 30); //fundo do game irá se movimentar a cada 0.3 segundos
